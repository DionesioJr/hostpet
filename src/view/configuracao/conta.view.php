           ...
           <div class="col">
             <div class="row align-items-center">
               <div class="col-auto">
                 ...
                 <!-- Avatar -->
                 <div class="avatar">
                   <img class="avatar-img rounded-circle" src="<?php echo $data['hostpet']['profile_pic_url'] ?>" alt="...">
                 </div>
               ...
               <div class="col ml-n2">
                 ...
                 <!-- Heading -->
                 <h4 class="mb-1">
                   <?php echo $data['hostpet']['full_name'] ?>
                 </h4>

                 <!-- Text -->
                 <small class="text-muted">
                   <?php echo $data['hostpet']['biography'] ?>
                 </small>
                 ...
                 <div class="card bg-light border ml-md-4">
                   <div class="card-body">
                     ...
                     <p class="small text-muted mb-2">
                       A senha deve ser modificada com a mesma senha usada para fazer login no hostpet, para que a automação não pare.
                     </p>
